...
\begin{document}\clearpage
    \input{01_Pre_Textual/A_Capa} 
    %\input{01_Pre_Textual/B_Folha_de_Aprovacao} 
    %\input{01_Pre_Textual/C_Ficha_Catalografica} 
    \pagestyle{plain} 
    \pagenumbering{roman} 
    %\input{01_Pre_Textual/D_Dedicatoria} 
    \input{01_Pre_Textual/E_Agradecimento} 
    % \input{01_Pre_Textual/G_Memorial} 
    \input{01_Pre_Textual/H_Resumo} 
    \input{01_Pre_Textual/I_Abstract}
 ...
 \pagestyle{plain}% headings como argumento coloca o cabeçalho
    ...
    \input{02_Textual/C1_Introducao}
    \input{02_Textual/C2_Fundamentacao}
    \input{02_Textual/C3_Trabalhos_relacionados}
    \input{02_Textual/C4_Proposta_solucao}
    \input{02_Textual/C5_Metodologia_plano_avaliacao}
    \input{02_Textual/C6_Plano_trabalho}
    \input{02_Textual/C7_Resultados_Esperados}
    \input{02_Textual/C8_Considerações_finais}
    ...
    % \input{02_Textual/Uso_da_IA}
    \input{03_Pos_Textual/A_Bibliografia}
    %\newpage
	%\thispagestyle{empty}
    %\mbox{}
    ...
    \include{03_Pos_Textual/1_Apendice}
    % \include{03_Pos_Textual/2_Apendice}
