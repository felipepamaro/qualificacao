...
\begin{document}\clearpage
    ...
    \input{01_Pre_Textual/B_Folha_de_Aprovacao} \input{01_Pre_Textual/C_Ficha_Catalografica} 
    \pagestyle{plain} 
    \pagenumbering{roman} 
 ...
 \pagestyle{plain}% headings como argumento coloca o cabeçalho
    ...
    \input{02_Textual/C3_Levantamento_Literatura}
    \input{02_Textual/C4_solucao_proposta}
    \input{02_Textual/C5_Construcao_artefato}
    \input{02_Textual/C6_Metodo_avaliacao}
