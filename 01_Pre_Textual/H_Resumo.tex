...
% Início do resumo
%------------------------------------------------------------------------------
Amaro, Felipe Pereira~\textbf{Inteligência artificial na escrita científica: um tutor de gênero automatizado para submissões em conferências brasileiras}. UNIRIO, 2026. \pageref{LastPage} páginas. Qualificação de Mestrado. Programa de Pós-Graduação em Informática, UNIRIO.
\vspace{10pt}
\begin{center}
    \textbf{RESUMO}
    \vspace{10pt}
