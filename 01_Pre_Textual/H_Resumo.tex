...
\textbf{Palavras-chave:}~Revisão Científica Automatizada; Agentes de Inteligência Artificial; Teoria de Gêneros; Design Science Research; Comunicação Científica; Modelos de Linguagem de Grande Escala (LLM); Geração Aumentada por Recuperação (RAG); Protocolo de Contexto de Modelo (MCP) 
\newpage
%------------------------------------------------------------------------------
% Fim do resumo
%------------------------------------------------------------------------------
