...
% Início do resumo
%------------------------------------------------------------------------------
Amaro, Felipe Pereira~\textbf{Inteligência artificial na escrita científica: um sistema multiagente de apoio a submissões em conferências brasileiras}. UNIRIO, 2026. \pageref{LastPage} páginas. Qualificação de Mestrado. Programa de Pós-Graduação em Informática, UNIRIO.
\vspace{10pt}
\begin{center}
    \textbf{RESUMO}
    \vspace{10pt}
...
Investiga-se, para isso, o projeto de um artefato de software capaz de apoiar a escrita científica. A proposta reposiciona a revisão automatizada: em vez de avaliar o manuscrito contra critérios universais de qualidade, um agente de conformidade de gênero modela o gênero comunicativo de uma trilha-alvo a partir do corpus de artigos já aceitos e verifica a conformidade do manuscrito submetido a essa especificação, gerando diagnósticos acionáveis. A ele soma-se um agente de fronteira de rejeição, que sinaliza ao autor, a partir de avaliações reais de artigos rejeitados, os motivos de recusa a que seu manuscrito pode estar exposto.
A fundamentação teórica articula a Teoria de Gêneros aplicada a Sistemas de Informação e a análise de \textit{moves} retóricos, na formulação do modelo CARS, integradas sob o método Design Science Research (DSR), envolvendo revisão de literatura, desenvolvimento do artefato e avaliação empírica.
...
Espera-se contribuir com um artefato utilizável, um método de derivação replicável a outras trilhas e conferências, e evidência empírica sobre a modelagem de gênero e a sinalização de risco de recusa no contexto brasileiro.
