...
O modelo \textit{Create a Research Space} (CARS\nomenclature{CARS}{Create a Research Space}) descreve a organização retórica de introduções de artigos científicos. Sua formulação original \cite{GenreAnalysis} propõe três \textbf{moves}: estabelecer o território,
...
Catorze anos depois, à luz de estudos que testaram o modelo em contextos diversos, \cite{ResearchGenres} apresenta uma versão revista, reproduzida na Tabela~\ref{tab:cars}. 
