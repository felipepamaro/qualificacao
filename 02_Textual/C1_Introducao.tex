...
Nesse contexto, surge a oportunidade de investigar a capacidade dos agentes de IA como instrumentos de apoio à iniciação científica, não com o objetivo de substituir revisores humanos, mas trabalhar como um tutor pesquisadores iniciantes visando ampliar a qualidade, a consistência e a escalabilidade na publicação de artigos acadêmicos em conferências brasileiras. Esta pesquisa busca contribuir para esse debate ao propor e investigar uma arquitetura multiagente voltada à análise automatizada de artigos científicos, com foco no contexto de periódicos brasileiros e na qualificação da produção científica nacional.
...
\begin{itemize}
    ...
    \item (ii) definir e implementar um método eficiente para extrair, de todo o corpus de uma conferência e a especificação de gênero de cada trilha
