...
\begin{itemize}
    \item (i) formular uma fundamentação teórica que articule a Teoria de Gêneros \cite{GenresOrgComm}, a análise de moves retóricos \cite{GenreAnalysis} sob o método DSR \cite{Hevner2004}.
    ...
    \item (iii) implementar o protótipo aplicado a conferências Brasileiras publicas no SOL (SBC OpenLib) \cite{solsbc}, integrando modelos locais e comerciais
